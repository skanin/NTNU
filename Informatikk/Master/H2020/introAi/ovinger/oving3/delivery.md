# Delivery of terminal output

Output when running command `python3 autograder.py -q q2 && python3 autograder.py -q q3`

```shell
❯ python3 autograder.py -q q2 && python3 autograder.py -q q3
...
Win Rate:      0/1 (0.00)
Record:        Loss
*** Finished running AlphaBetaAgent on smallClassic after 20 seconds.
*** Won 0 out of 1 games. Average score: 84.000000 ***
